...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', default='/home/federico/Desktop/D-Drone_v2/result',
...
def infer(images_path, model, postprocessors, device, output_path):
    ...
    for img_sample in images_path:
        ...
        filesave = '/home/federico/Desktop/D-Drone_v2/Detect/exp'+filename
...
if __name__ == "__main__":
    ...
    model.to(device)
    shutil.rmtree('/home/federico/Desktop/D-Drone_v2/Detect/exp')
    os.mkdir('/home/federico/Desktop/D-Drone_v2/Detect/exp')
