...
if __name__ == "__main__":
    ...
    # rospy.loginfo("[img_server.py] Publishing to /output/detected_image ...")
    # image_pub = rospy.Publisher("/output/detected_image", CompressedImage, queue_size=1)
    
    rospy.loginfo("[img_server.py] Publishing to /output/image_raw/compressed ...")
